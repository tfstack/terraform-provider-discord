...
func TestServersDataSource_Metadata(t *testing.T) {
...
func TestServersDataSource_Schema(t *testing.T) {
	ds := NewServersDataSource()
	...
	assert.True(t, ok)
	assert.True(t, serversAttr.IsComputed())
}

func TestServersDataSource_Configure(t *testing.T) {
	tests := []struct {
		name          string
